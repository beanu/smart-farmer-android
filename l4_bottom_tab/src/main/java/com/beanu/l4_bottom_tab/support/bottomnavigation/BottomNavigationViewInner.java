package com.beanu.l4_bottom_tab.support.bottomnavigation;
...
//        mMenuView.updateMenuView();
     ...
     * @param viewPager
     */
    public BottomNavigationViewInner setupWithViewPager(final ViewPager2 viewPager) {
     ...
     * not cause a leak.
     */
    private static class BottomNavigationViewExOnPageChangeListener extends ViewPager2.OnPageChangeCallback {
